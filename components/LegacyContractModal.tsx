      ...
      <div className="relative w-full max-w-lg bg-card border border-border rounded-2xl shadow-2xl max-h-[90vh] overflow-auto animate-fade-in">
        ...
        <div className="p-5 space-y-4">
          ...
          <Field label="Observações (opcional)">
            <textarea
              ...
              rows={2}
              className="w-full bg-surface border border-border rounded-lg px-3 py-2 text-sm text-foreground outline-none focus:border-primary/50 resize-none"
            />
          </Field>
          ...
          <Field label="PDF assinado">
            ...
            />
            {file && <p className="text-[11px] text-lone-success mt-1">{file.name} ({(file.size / 1024).toFixed(0)} KB)</p>}
          </Field>
          ...
          {ok && (
            <div className="flex items-start gap-2 rounded-lg border border-lone-success-border bg-lone-success-bg p-2.5">
              <FileCheck2 size={12} className="text-lone-success mt-0.5 shrink-0" />
              <p className="text-xs text-lone-success">{ok}</p>
            </div>
          )}
        </div>
        ...
        <div className="flex items-center justify-end gap-2 p-5 border-t border-border sticky bottom-0 bg-card">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-primary hover:bg-primary/80 text-primary-foreground text-xs font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
