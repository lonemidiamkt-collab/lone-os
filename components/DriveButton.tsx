    ...
    return (
      <button
        ...
        className={cn(
          ...
          isValid
            ? "border-[#0d4af5]/20 bg-[#0d4af5]/[0.04] hover:border-[#0d4af5]/50 hover:bg-[#0d4af5]/[0.08] hover:shadow-[0_0_20px_rgba(10,52,245,0.15)] cursor-pointer"
      ...
      >
        <div className={cn(
          ...
          isValid
            ? "bg-[#0d4af5]/15 shadow-[0_0_10px_rgba(10,52,245,0.2)] group-hover:shadow-[0_0_16px_rgba(10,52,245,0.4)]"
            : "bg-zinc-800/50"
        )}>
  ...
  return (
    <button
      ...
      className={cn(
        ...
        isValid
          ? "border border-[#0d4af5]/20 bg-[#0d4af5]/[0.06] hover:border-[#0d4af5]/50 hover:bg-[#0d4af5]/[0.12] hover:shadow-[0_0_16px_rgba(10,52,245,0.25)] cursor-pointer"
