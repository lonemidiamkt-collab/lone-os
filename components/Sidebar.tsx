    ...
    <>
      ...
      <aside className={cn(
        ...
        <Link href="/" className="group shrink-0">
          <div className="w-10 h-10 rounded-2xl bg-background flex items-center justify-center group-hover:scale-[1.02] transition-all duration-300 overflow-hidden">
        ...
        <button
          ...
          className="w-8 h-8 rounded-lg flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-foreground/[0.04] transition-all mt-2 mb-1 shrink-0"
          ...
          {visibleItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {expanded && (
                  <span className={`text-xs font-medium truncate ${isPage ? "text-foreground" : "text-muted-foreground"}`}>
                    {item.label}
                  </span>
                )}
        ...
        <div className="flex flex-col items-center gap-1 shrink-0">
          <button
            onClick={toggleTheme}
            className="w-9 h-9 rounded-xl flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-foreground/[0.04] transition-all"
          ...
          <button
            onClick={logout}
            className="w-9 h-9 rounded-xl flex items-center justify-center text-muted-foreground hover:text-red-400 hover:bg-red-500/5 transition-all"
            title="Sair"
          >
            <LogOut size={15} />
          </button>
          ...
          <>
            ...
            <div className="flex items-center justify-between px-4 pt-6 pb-4">
              ...
              <button
                ...
                className="w-6 h-6 rounded-md flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-foreground/5 transition-all"
                title="Fechar painel"
              >
                <ChevronLeft size={13} />
              </button>
            ...
            {/* Separator */}
            <div className="h-px bg-foreground/[0.04] mx-3 mb-3" />
            ...
            <div className="px-3 py-3 border-t border-white/[0.04]">
              <div className="flex items-center gap-2.5 px-2 py-2 rounded-lg hover:bg-foreground/[0.03] transition-colors cursor-default">
