...
import { Bell, ChevronDown, Plus, X, UserPlus, FileText, Smile, Search, ChevronRight, LogIn, Sun, Moon } from "lucide-react";
  ...
  return (
    <header className="h-16 border-b border-border bg-background flex items-center px-4 pl-16 lg:pl-6 lg:px-6 gap-3 lg:gap-4 shrink-0 relative z-[100]">
      ...
      <div className="relative">
        <div className="flex items-center gap-2 bg-muted rounded-xl px-3 py-2 w-52 border border-border focus-within:border-primary/50 focus-within:shadow-[0_0_20px_rgba(10,52,245,0.1)] transition-all">
        ...
        {hasResults && (
          <div className="absolute top-full mt-1 left-0 w-72 bg-popover border border-white/[0.08] rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.8)] z-[200] py-1 animate-fade-in max-h-80 overflow-y-auto">
      ...
      <button
        onClick={toggleTheme}
        className="w-8 h-8 rounded-xl bg-muted border border-border flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-foreground/20 transition-all"
      ...
      <div className="relative" ref={quickRef}>
        <button
          ...
          className="w-8 h-8 rounded-xl bg-muted border border-border flex items-center justify-center hover:border-foreground/20 transition-all group"
          title="Ações rápidas"
        >
        ...
        {showQuick && (
          ...
          <div className="absolute right-0 top-full mt-2 w-52 bg-popover border border-white/[0.08] rounded-xl shadow-[0_8px_30px_rgba(0,0,0,0.6)] z-[200] py-2 animate-fade-in">
      ...
      <div className="relative">
        <button
          ...
          className="flex items-center gap-2 bg-muted border border-border rounded-xl px-2.5 py-1.5 hover:border-border transition-all"
        >
        ...
        {showMenu && (
          <>
            ...
            <div className="absolute right-0 top-full mt-2 w-52 bg-popover border border-white/[0.08] rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.8)] z-[200] py-2 animate-fade-in">
              ...
              <button
                ...
                className="w-full flex items-center gap-2 px-3 py-2 text-sm text-muted-foreground hover:text-red-400 hover:bg-red-500/5 transition-colors"
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {(notif.clientId || cfg.route) && (
                    <div className="flex items-center gap-2 mt-1.5">
                      ...
                      {cfg.route && (
                        <Link href={cfg.route} className="text-[10px] text-muted-foreground hover:text-foreground flex items-center gap-0.5">
