    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="text-center animate-fade-in space-y-6 relative z-10">
          <div className="w-20 h-20 rounded-2xl bg-background flex items-center justify-center mx-auto shadow-[0_0_50px_rgba(10,52,245,0.5),0_0_100px_rgba(10,52,245,0.15)]">
    ...
    <div className="min-h-screen bg-background flex items-center justify-center relative overflow-hidden">
      ...
      <div className={`relative z-10 w-full max-w-[420px] mx-4 transition-all duration-700 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        ...
        <div className="text-center mb-10">
          <div className="w-14 h-14 rounded-xl bg-background flex items-center justify-center mx-auto mb-5 shadow-[0_0_40px_rgba(10,52,245,0.35),0_0_80px_rgba(10,52,245,0.1)]">
              ...
              <div className="space-y-2">
                ...
                <div className="relative" ref={dropdownRef}>
                  <button
                    ...
                    className={`w-full bg-muted border rounded-xl px-4 py-3.5 text-sm text-left outline-none transition-all flex items-center justify-between ${
                      showDropdown
                  ...
                  {/* Dropdown list */}
                  {showDropdown && (
                    <div className="absolute top-full mt-2 left-0 right-0 bg-muted border border-border rounded-xl shadow-[0_12px_40px_rgba(0,0,0,0.8)] z-50 py-1 animate-fade-in max-h-64 overflow-y-auto">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    autoComplete="off"
                    className={`w-full bg-muted border rounded-xl px-4 py-3.5 text-sm text-foreground outline-none transition-all placeholder:text-muted-foreground ${
                      error
