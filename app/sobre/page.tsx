...
const MODULES: Module[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "PDF de DESEMPENHO da semana (toda sexta, 18h) — duas peças da mesma base: o resumo da operação vai pro grupo administrativo SEM nome de pessoa (produção, prazo, retrabalho, pedidos parados), e cada pessoa recebe o cartão da própria função, porque designer e social media medem coisas diferentes. As metas saíram da média da própria operação medida em 60 dias, não de número inventado — são para revisar com o time depois da primeira rodada",
