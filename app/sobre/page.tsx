...
const MODULES: Module[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "ESTILO VISUAL POR PRINTS (14/09): na aba Inteligência Criativa, suba de 1 a 4 prints do Instagram do cliente e a IA descreve o que está lá — paleta (com as cores), tipografia, composição, o que se repete, tom e o que evitar. Isso entra no briefing de TODA variação de vencedor mandada ao designer e na prévia de imagem. A IA descreve o que vê; quem decide se aquilo é a cara da marca é a equipe. Sem prints, ela só conhece o estilo pelos anúncios da Meta e pelas artes entregues.",
