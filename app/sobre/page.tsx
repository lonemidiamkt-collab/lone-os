...
const MODULES: Module[] = [
  ...
  },
  {
    ...
    icon: Instagram,
    title: "Social Media",
    shortDesc: "Board de produção + aprovação + resultados contados no Instagram",
    whoUses: "Admin, Manager, Social, Designer",
  ...
  },
  {
    ...
    icon: Palette,
    title: "Designer",
    shortDesc: "Quadro de tarefas com pedidos e auto-iniciadas",
    ...
    howItWorks: [
      "Na aba /design, o painel tem: Kanbans Social Media, Quadro de Tarefas, Performance e Histórico. A carteira de clientes é a lista única de Clientes (Clientes › Meus Clientes) — a aba 'Clientes do Quadro' virou esse filtro na Leva 5a.",
