...
const MODULES: Module[] = [
  ...
  },
  {
    ...
    howItWorks: [
      ...
      "A reunião aparece pra QUEM CUIDA do cliente, não só pro social: o gestor de tráfego e o designer daquele cliente veem a agenda dele no Calendário e no Meu Trabalho. O gestor de tráfego vê as reuniões que existem, não a lista de 'quem falta marcar' — marcar é tarefa do social.",
