...
const MODULES: Module[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "O Radar entrega em /radar, no menu: cada oportunidade mostra o quanto combina com aquele cliente, a força do movimento no mercado, a ideia, o roteiro, e — obrigatoriamente — de qual conteúdo saiu: qual perfil, quantos seguidores, quantas vezes passou do normal dele, e com que material a leitura foi feita. Três botões: vou usar, não serve (com motivo) e guardar. Descarte com motivo é como o sistema aprende o que não serve para este time",
