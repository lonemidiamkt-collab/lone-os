...
const MODULES: Module[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "CATÁLOGO DE PRODUTOS (14/09): na aba Inteligência Criativa e no drawer do designer — nome, marca, código, categoria, preço, descrição e FOTOS (clique na miniatura para subir). Começa semeado com os produtos do briefing (302 itens em 54 clientes, sem foto — a equipe completa); cada produto mostra em quantos anúncios apareceu. O designer para de procurar a foto do produto toda vez.",
