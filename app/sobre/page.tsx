...
const MODULES: Module[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "PORTAL: CONTEÚDO ENTREGUE ESTAVA VAZIO (18/09): a equipe arquiva o card depois de postar para limpar o quadro (~25 por dia), e o portal do cliente excluía arquivados — 603 artes entregues de 40 clientes ficavam invisíveis (UNAFER 9 de 9, Calabria 27 de 27). Arquivar é organização do time; para o cliente, arte entregue é arte entregue. Também: a capa mostrada ao cliente era o PRIMEIRO anexo por posição, que em 181 cards era a REFERÊNCIA (print do social ou de concorrente) — agora a capa é sempre a arte (entrega), nunca a referência.",
