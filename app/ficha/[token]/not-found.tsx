...
export default function FichaVivaNotFound() {
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center px-6 text-center">
      <div className="mb-5 w-14 h-14 rounded-full bg-muted flex items-center justify-center">
        <Lock size={24} className="text-muted-foreground" aria-hidden="true" />
      </div>
      <h1 className="text-lone-h1 font-semibold tracking-tight mb-2">Link expirado ou inválido</h1>
