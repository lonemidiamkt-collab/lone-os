...
/**
 * Conteúdo da página /dev/tokens — componente client.
 * Separado para que page.tsx possa ser um Server Component
 * e fazer o guard de autenticação server-side.
 */
  ...
  return (
    <div className="min-h-screen p-8 font-inter bg-lone-bg-primary text-lone-text-primary">
      <div className="max-w-5xl mx-auto space-y-14">
        ...
        <section>
          <SectionDivider label="KPICard" badge="8 variações" className="mb-5" />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-3">
            ...
            <KPICard label="Clicável"   value={5}        caption="clique para ver"   tone="info"
