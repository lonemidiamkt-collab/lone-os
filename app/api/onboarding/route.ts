    ...
    if (formData.clientId) {
      ...
      try {
        ...
        if (jid) {
          ...
          // O LINK DIRETO. Roberto (10/09): "poderia ter vindo com o link já do cadastro do
          // cliente, iria adiantar muito." Mandar o caminho por extenso ("Clientes → Cadastros
          // Pendentes → Revisar") obriga a pessoa a navegar até achar — e o id do cliente já está
          // aqui na mão.
          ...
          const msg = `🎉 *${clientName}* concluiu o cadastro do onboarding (100%)!\n`
            ...
            + `\n👉 ${linkFicha}\n`
            + `Falta revisar e ativar em *Clientes → Cadastros Pendentes* (botão "Revisar").\n\n`
